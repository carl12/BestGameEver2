...
public class Character {
   ...
   private int level;
   /*
    * I want to use linkedlists not arrays, 
    * they give more flexibility for equipping more items
    */
...
/**
 * I want to use a linked list here but I do not want to screw something up -Carl
 * @param anItem
 * @throws IOException
 */
   ...
   /**
    * Damages based off of incoming damage, and defenses
    * sets isDead = true if health goes below zero
    * @param damage - initial damage by attack
    * @return healthStat - current health
    */
   ...
   /**
    * sets character health to zero, killing it
    */
   public void kill()
   {
      isDead = true;
